...
class DrumConfig extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("div", { id: "drum-config" }, /*#__PURE__*/
...
class KeyPad extends React.Component {
  ...
  renderKeyButton(key, url, sample) {
    return /*#__PURE__*/(
      React.createElement(KeyButton, { name: key, id: sample, url: url }));
  ...
  renderKeyPad() {
    ...
    for (let row = 0; row < 3; row++) {
      ...
      keyboard.push( /*#__PURE__*/
      React.createElement("div", { className: String("board-row " + aditionalClass) },
      keyRow));
...
class DrumMachine extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement(DrumConfig, {
